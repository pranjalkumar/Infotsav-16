...
<html>
	<head>
		<title>RoboFiesta Events |Infotsav'16</title>
		<meta charset="utf-8" />
...
{ if($i%2==0)
	...
	<?php
					...
					<article class="feature left" style="box-shadow: 5px 5px 3px #888888;background-color: rgba(0,0,0,0.9); ">
						<span class="image"><img  style="margin-left: 15%;" src="img/<?php echo $EVENTLIST->EVENT[$i]->IMAGE; ?>"  alt="" /></span>
						<div class="content" >
...
<!-- start of new section -->
						...
						<div class="content" >
							<center><h2 style="color:white;font-size:2.2vw;font-weight:500;font-family: inherit;margin-bottom: 5%;"><span style="border: solid;padding: 2%;font-family: induction;"><?php
           						 $xml = file_get_contents('events.xml');
            					 $EVENTLIST = new SimpleXMLElement($xml);
