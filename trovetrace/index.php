...
//print_r( $info);
                                          ...
                                          $sec = $info['seconds'];
                                           $flag=0;
                                           if(($date==10&&$month==11&&$year==2016&&$min>=00&&$sec>=00&&$hour>=23)||($date==11&&$month==11&&$year==2016))
                        					$flag=1;
        									...
        									$flag=2;
                                                    ...
                                                    //               $flag=1;
																	if($flag==0)
                                                                             { ?>
                                           <center><a href="#" class="button button-big button-icon button-icon-check">Hold your horses till 11:00PM 10/11/2016 </a></center>
                                             <?php }
                                            else if($flag==2)
...
?>
	...
	<center><a id="redir" href="<?php echo $urll; ?>"  class="button button-big button-icon button-icon-check">Play Game!</a></center> <!--sends to current level in game-->
            <?php } }else {?>
